...
<body>
    ...
    <hr>
    <div class="container">
        <h1>คู่มือนักศึกษา</h1>
        <div class="card" style="width: 18rem;">
            <img src="https://acad.srru.ac.th/wp-content/uploads/2019/06/manual2561-440x264.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">คู่มือนักศึกษา</h5>
                <p class="card-text"></p>
